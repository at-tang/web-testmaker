...
export default function PageSelect(
    {
        currentPage, setCurrentPage, maxPages
    }:
    {
        currentPage: number,
    ...
    return (
        <>
            <div 
            onClick={() => {handleClick()}}
            className="border-2 border-white h-8 sm:w-32 w-full rounded-2xl text-center select-none hover:cursor-pointer hover:scale-102 transition ease-in-out mb-2">
