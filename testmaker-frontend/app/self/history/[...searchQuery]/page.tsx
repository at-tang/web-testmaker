...
export default function History({params}: {params: Promise<{searchQuery?: string[]}>}) {

    const resolvedParams = useParams();
    const searchQuery = resolvedParams.searchQuery?.[0] || ''
    ...
    return (
        <>
            ...
            <div className="p-4">
                <QuizResultListMaster 
                searchEnabled={true} 
                apiCall="api/private/result/get/list/general"
